        ...
        <main role="main" class="container" id="app">
            ...
            <div class="row mt-5">
                <div class="col-12 mb-4">
                    ...
                    <a href="{{ URL::to('uploadquotation/PR2') }}" class="btn btn btn-dark disabled">
                        Upload Quotation
                    </a>
                </div>
                ...
                <div class="col-12 mb-4">
                    <div class="alert alert-info" role="alert">
                        ...
                        <span>3 days left to <a href="#" class="alert-link">Update and reveiwe</a> the quotations</span>
                        <hr>
                        <span>You wont be able to review or update quotation status after the <a href="#" class="alert-link">three days</a> Windows is closed</span>
                    </div>
